...
class Stripe extends BasePaymentMethod
{
    ...
    public function makePayment($orderItem, $calendarSlot, $order)
    {
        ...
        $paymentArgs = [
            ...
            'currency'            => strtolower((string) ($currency ?: 'usd')),
    ...
    public function confirmStripePayment()
    {
        ...
        $expectedAmount = $isZeroDecimal ? (int) round($orderAmount / 100) : $orderAmount;
    ...
    public function refundPayment($orderItem, $calendarSlot)
    {
        ...
        $stripeRefundAmount = $isZeroDecimal ? (int) round($refundAmount / 100) : $refundAmount;
    ...
    public function intentData($booking, $args)
    {
        ...
        $sessionPayload = array(
            ...
            'metadata'             => [
                ...
                'guest_name'  => Helper::getDisplayNameFromUser($booking),
