...
// Push the required FluentBooking core update straight from wordpress.org during the
// WP.org update-check cool-down window (see PluginInstaller for details).
(new \FluentBookingPro\App\Services\PluginManager\PluginInstaller())->registerCoreUpdater();
